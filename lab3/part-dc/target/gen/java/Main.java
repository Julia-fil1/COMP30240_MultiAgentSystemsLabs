...
public class Main extends ASTRAClass {
	public Main() {
		...
		addRule(new Rule(
			...
			new Block(
				"Main", new int[] {46,31,57,5},
				new Statement[] {
					new Subgoal(
						"Main", new int[] {47,8,57,5},
						new Goal(
							new Predicate("switch", new Term[] {
					...
					new ModuleCall("console",
						"Main", new int[] {55,8,55,65},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
								Primitive.newPrimitive("flash: this was iteration number: "),
								new Variable(Type.INTEGER, "X")
							)
						}),
						new DefaultModuleCallAdaptor() {
		...
		addRule(new Rule(
			...
			new Block(
				"Main", new int[] {59,32,62,5},
				new Statement[] {
					new ModuleCall("console",
						"Main", new int[] {60,8,60,73},
						new Predicate("println", new Term[] {
							Primitive.newPrimitive("flash: flashing completed, exiting the program")
						}),
						new DefaultModuleCallAdaptor() {
							public boolean inline() {
								return true;
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Main", new int[] {64,26,67,6},
				new Statement[] {
					new ModuleCall("console",
						"Main", new int[] {65,8,65,119},
						new Predicate("println", new Term[] {
