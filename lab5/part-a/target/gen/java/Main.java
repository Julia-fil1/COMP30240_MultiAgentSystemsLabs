...
public class Main extends ASTRAClass {
	public Main() {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Main", new int[] {4,25,9,3},
				new Statement[] {
					new ModuleCall("system",
						"Main", new int[] {5,4,5,39},
						new Predicate("createAgent", new Term[] {
							Primitive.newPrimitive("ping1"),
					...
					new ModuleCall("system",
						"Main", new int[] {6,4,6,39},
						new Predicate("createAgent", new Term[] {
							Primitive.newPrimitive("ping2"),
							Primitive.newPrimitive("Ping")
						}),
						new DefaultModuleCallAdaptor() {
							public boolean inline() {
